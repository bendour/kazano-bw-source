...
BaseWars.DefaultConfig.SellCooldown = 5
...
BaseWars.DefaultConfig.MinPropHP = 400
...
BaseWars.DefaultConfig.MinimumRaidLevel = 600
BaseWars.DefaultConfig.RaidDuration = 600
BaseWars.DefaultConfig.RaidImmunity = 1200
BaseWars.DefaultConfig.ShootPeopleInRaid = false
BaseWars.DefaultConfig.GlobalImmunity = 190
...
BaseWars.DefaultConfig.Premium = {
	["Premium"] = true,
}
...
BaseWars.DefaultConfig.RaidRequirements = {
	["Faction"] = 0,
	["Solo"] = 0
}
