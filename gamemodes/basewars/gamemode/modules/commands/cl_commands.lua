...
--[[-------------------------------------------------------------------------
	Annonce
---------------------------------------------------------------------------]]
BaseWars:AddTranslation("EChatCommand_announcement", "fr", "Faire une annonce")
BaseWars:AddTranslation("EChatCommand_announcement", "en", "Make an announcement")
BaseWars:AddChatCommand({"announcement", "annonce"}, BaseWars:GetAdminGroups(true), "#EChatCommand_announcement", {
	"<message>"
})
