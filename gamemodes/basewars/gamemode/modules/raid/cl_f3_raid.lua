...
function PANEL:Init()
	...
	for _, ply in player.Iterator() do
		...
		playerPanel:SetAccentColor(GetBaseWarsTheme("bws_accent") or GetBaseWarsTheme("gen_accent"))
	...
	self.BottomBar.StartRaid:SetAccentColor(GetBaseWarsTheme("bws_accent") or GetBaseWarsTheme("gen_accent"))
	self.BottomBar.StartRaid.LerpFunc = function(s)
		return s:IsHovered()
	end
	...
	self.BottomBar.StartRaid.DoClick = function(s)
		...
		if immunityBool then
			BaseWars:Notify("#raids_playerImmunity", NOTIFICATION_ERROR, 5)
			s:Disable(1.5, self.colors.disabled, s.Draw)
	...
	self.BottomBar.StopRaid:SetAccentColor(GetBaseWarsTheme("bws_accent") or GetBaseWarsTheme("gen_accent"))
	self.BottomBar.StopRaid.LerpFunc = function(s)
		return s:IsHovered()
	end
