...
-- hook.Add("BaseWars:Prestige:OnPlayerPrestige", "Guez", function(ply)
-- 	print("3", ply:GetMoney(), ply:GetLevel(), ply:GetXP())
-- end)
...
hook.Add("BaseWars:BuyPrestigePerk", "BaseWars:Prestige", function(ply, perk)
	if perk == "playerHealth" then
