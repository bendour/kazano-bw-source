...
function PANEL:Init()
	...
	if BaseWars:IsSuperAdmin(self.localPlayer) then
		...
		self.Topbar.PlayerConfig:SetColor(GetBaseWarsTheme("bws_contentBackground"), true)
		self.Topbar.PlayerConfig:SetAccentColor(GetBaseWarsTheme("bws_accent"))
		self.Topbar.PlayerConfig.Draw = function(s,w,h)
			draw.SimpleText(self.localPlayer:GetLang("config_playerConfig"), "BaseWars.24", w * .5, h * .5, GetBaseWarsTheme("bws_text"), 1, 1)
		end
		...
		self.Topbar.GamemodeConfig:SetColor(GetBaseWarsTheme("bws_contentBackground"), true)
		self.Topbar.GamemodeConfig:SetAccentColor(GetBaseWarsTheme("bws_accent"))
		self.Topbar.GamemodeConfig.Draw = function(s,w,h)
			draw.SimpleText(self.localPlayer:GetLang("config_gamemodeConfig"), "BaseWars.24", w * .5, h * .5, GetBaseWarsTheme("bws_text"), 1, 1)
		end
	...
	self.Content:PaintScrollBar("bws")
...
function PANEL:Build(config, filter)
	...
	if config == "gamemode" and BaseWars:IsSuperAdmin(self.localPlayer) then
		...
		if not IsValid(self.Top) then
			...
			self.Top.Filter:SetColor(GetBaseWarsTheme("bws_background"))
			self.Top.Filter:SetTextColor(GetBaseWarsTheme("bws_text"))
			self.Top.Filter:SetFont("BaseWars.18")
			self.Top.Filter:SetPlaceHolder(self.localPlayer:GetLang("search"))
			self.Top.Filter:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
		...
		if not IsValid(self.Bottom) then
			...
			self.SaveConfig:SetColor(GetBaseWarsTheme("bws_contentBackground"), true)
			self.SaveConfig:SetAccentColor(GetBaseWarsTheme("bws_accent"))
			self.SaveConfig.Draw = function(s,w,h)
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_saveConfig"), "BaseWars.20", w * .5, h * .5, GetBaseWarsTheme("bws_text"), 1, 1)
			end
			...
			self.ResetConfig:SetColor(GetBaseWarsTheme("bws_contentBackground"), true)
			self.ResetConfig:SetAccentColor(GetBaseWarsTheme("bws_accent"))
			self.ResetConfig.Draw = function(s,w,h)
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_resetConfig"), "BaseWars.20", w * .5, h * .5, GetBaseWarsTheme("bws_text"), 1, 1)
			end
		...
		for k, v in SortedPairsByMemberValue(configTyped, "type") do
			...
			configPanel.lerpColor = GetBaseWarsTheme("bws_contentBackground")
			configPanel.Paint = function(s,w,h)
				if not isTable then
					s.lerpColor = BaseWars:LerpColor(FrameTime() * 15, s.lerpColor, (s:IsHovered() or s:IsChildHovered()) and GetBaseWarsTheme("bws_background") or GetBaseWarsTheme("bws_contentBackground"))
				end

				local bgCol = ColorAlpha(s.lerpColor, 90)
				local accent = GetBaseWarsTheme("bws_accent")
				
				BaseWars:DrawRoundedBox(12, 0, 0, w, h, bgCol)
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
				
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_" .. k .. "Name"), "BaseWars.22", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, TEXT_ALIGN_BOTTOM)
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_" .. k .. "Desc"), "BaseWars.18", bigMargin, h * .5, GetBaseWarsTheme("bws_darkText"), 0, TEXT_ALIGN_TOP)
			end
		...
		for k, v in SortedPairsByMemberValue(BaseWars.DefaultPlayerConfig, "type") do
			...
			configPanel.Paint = function(s,w,h)
				...
				draw.SimpleText(self.localPlayer:GetLang("f3config", k .. "Name"), "BaseWars.22", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, TEXT_ALIGN_BOTTOM)
				draw.SimpleText(self.localPlayer:GetLang("f3config", k .. "Desc"):format(input.LookupBinding("gm_showspare2") or "?"), "BaseWars.18", bigMargin, h * .5, GetBaseWarsTheme("bws_darkText"), 0, TEXT_ALIGN_TOP)
			end
			...
			if v.choices then
				...
				configPanel.Action:SetColor(GetBaseWarsTheme("bws_contentBackground"), true)
				configPanel.Action:SetAccentColor(GetBaseWarsTheme("bws_accent"))
				configPanel.Action.Draw = function(s,w,h)
					draw.SimpleText(v.choices[s.value] or "???", "BaseWars.20", w * .5, h * .5, GetBaseWarsTheme("bws_text"), 1, 1)
				end
...
function PANEL:BuildTable(key, parent, subParent)
	...
	if key == "PrinterCap" then
		...
		for k, v in SortedPairs(tbl) do
			...
			item.lerpColor = GetBaseWarsTheme("bws_contentBackground")
			item.Paint = function(s,w,h)
				s.lerpColor = BaseWars:LerpColor(FrameTime() * 15, s.lerpColor, (s:IsHovered() or s:IsChildHovered()) and GetBaseWarsTheme("bws_background") or GetBaseWarsTheme("bws_contentBackground"))

				BaseWars:DrawRoundedBox(12, 0, 0, w, h, ColorAlpha(s.lerpColor, 90))
				local accent = GetBaseWarsTheme("bws_accent")
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
				draw.SimpleText(k, "BaseWars.22", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, TEXT_ALIGN_CENTER)
			end
			...
			item.RemoveItem.color = GetBaseWarsTheme("bws_darkText")
			item.RemoveItem.Paint = function(s,w,h)
				s.color = BaseWars:LerpColor(FrameTime() * 20, s.color, s:IsHovered() and GetBaseWarsTheme("gen_accent") or GetBaseWarsTheme("bws_darkText"))
		...
		parent.Action.color = GetBaseWarsTheme("bws_darkText")
		...
		parent.Number:SetColor(GetBaseWarsTheme("bws_background"))
		parent.Number:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.Number:SetFont("BaseWars.18")
		parent.Number:SetPlaceHolder(self.localPlayer:GetLang("config_number"))
		parent.Number:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
		...
		parent.UserGroup:SetColor(GetBaseWarsTheme("bws_background"))
		parent.UserGroup:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.UserGroup:SetFont("BaseWars.18")
		parent.UserGroup:SetPlaceHolder(self.localPlayer:GetLang("gamemodeConfig_userGroup"))
		parent.UserGroup:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
	end
	...
	if BaseWars.DefaultConfigType[key] == BWCONFIGTYPE_KEYVALUE then
		...
		for k, v in SortedPairs(tbl) do
			...
			item.Paint = function(s,w,h)
				...
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_" .. key, k .. "Name"), "BaseWars.22", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, TEXT_ALIGN_BOTTOM)
				draw.SimpleText(self.localPlayer:GetLang("gamemodeConfig_" .. key, k .. "Desc"), "BaseWars.18", bigMargin, h * .5, GetBaseWarsTheme("bws_darkText"), 0, TEXT_ALIGN_TOP)
			end
	...
	if key == "FormatNumber" then
		...
		for k, v in SortedPairs(tbl) do
			...
			item.Paint = function(s,w,h)
				...
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
				draw.SimpleText(v[2] .. " [" .. v[3] .. "]", "BaseWars.20", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, 1)
			end
		...
		parent.ShortText:SetColor(GetBaseWarsTheme("bws_background"))
		parent.ShortText:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.ShortText:SetFont("BaseWars.18")
		parent.ShortText:SetPlaceHolder(self.localPlayer:GetLang("gamemodeConfig_shortText"))
		parent.ShortText:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
		...
		parent.Text:SetColor(GetBaseWarsTheme("bws_background"))
		parent.Text:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.Text:SetFont("BaseWars.18")
		parent.Text:SetPlaceHolder(self.localPlayer:GetLang("config_string"))
		parent.Text:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
	...
	if BaseWars.DefaultConfigType[key] == BWCONFIGTYPE_NOKEY then
		...
		if key == "WhitelistProps" then
			...
			for k, v in ipairs(tbl) do
				...
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
					draw.SimpleText(text, "BaseWars.20", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, 1)
				end
		...
		parent.TextEntry:SetColor(GetBaseWarsTheme("bws_background"))
		parent.TextEntry:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.TextEntry:SetFont("BaseWars.18")
		parent.TextEntry:SetPlaceHolder(self.localPlayer:GetLang("gamemodeConfig_" .. placeHolder))
		parent.TextEntry:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
	end
	...
	if BaseWars.DefaultConfigType[key] == BWCONFIGTYPE_KEY then
		...
		for k, v in SortedPairs(tbl) do
			...
			item.Paint = function(s,w,h)
				...
				surface.SetDrawColor(accent.r or 255, accent.g or 255, accent.b or 255, 30)
				surface.DrawOutlinedRect(1, 1, w - 2, h - 2)
				draw.SimpleText(k, "BaseWars.20", bigMargin, h * .5, GetBaseWarsTheme("bws_text"), 0, 1)
			end
...
function PANEL:BuildAction(type, parent, defaultValue, tbl, key)
	...
	if type == "number" then
		...
		parent.Action:SetColor(GetBaseWarsTheme("bws_background"))
		parent.Action:SetTextColor(GetBaseWarsTheme("bws_text"))
		parent.Action:SetFont("BaseWars.18")
		parent.Action:SetPlaceHolder(self.localPlayer:GetLang("config_number"))
		parent.Action:SetPlaceHolderColor(GetBaseWarsTheme("bws_darkText"))
