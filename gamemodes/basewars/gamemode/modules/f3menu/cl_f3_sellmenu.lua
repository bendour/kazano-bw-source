...
function PANEL:Init()
	...
	self.Topbar.All.Paint = function(s,w,h)
		...
		draw.SimpleText(self.localPlayer:GetLang("sellmenu_allEntities"), "BaseWars.24", w * .5, h * .5, GetBaseWarsTheme("bws_text") or GetBaseWarsTheme("bwm_text"), 1, 1)
	end
	...
	self.Topbar.Selected.Paint = function(s,w,h)
		BaseWars:DrawRoundedBox(4, 0, 0, w, h, GetBaseWarsTheme("bws_contentBackground") or GetBaseWarsTheme("bwm_contentBackground"))
		draw.SimpleText(self.localPlayer:GetLang("sellmenu_selectedEntities"), "BaseWars.24", w * .5, h * .5, GetBaseWarsTheme("bws_text") or GetBaseWarsTheme("bwm_text"), 1, 1)
	end
	...
	self.ButtonsPanel.All = self.ButtonsPanel:Add("BaseWars.Button")
	...
	self.ButtonsPanel.All:SetColor(GetBaseWarsTheme("bws_contentBackground") or GetBaseWarsTheme("bwm_contentBackground"), true)
	self.ButtonsPanel.All:SetAccentColor(GetBaseWarsTheme("bws_accent") or GetBaseWarsTheme("gen_accent"))
	self.ButtonsPanel.All.LerpFunc = function(s)
		return s:IsHovered()
	end
	self.ButtonsPanel.All.Draw = function(s,w,h)
		draw.SimpleText(self.localPlayer:GetLang("sellmenu_sellallfor"):format(BaseWars:FormatMoney(self.totalValue * BaseWars.Config.BackMoney)), "BaseWars.20", w * .5, h * .5, GetBaseWarsTheme("bws_text") or GetBaseWarsTheme("bwm_text"), 1, 1)
	end
	...
	self.ButtonsPanel.Selected = self.ButtonsPanel:Add("BaseWars.Button")
	self.ButtonsPanel.Selected:Dock(RIGHT)
	self.ButtonsPanel.Selected:DockMargin(bigMargin, bigMargin, bigMargin, bigMargin)
	self.ButtonsPanel.Selected:SetWide((self.w - bigMargin * 5) * .5)
	self.ButtonsPanel.Selected:SetColor(GetBaseWarsTheme("bws_contentBackground") or GetBaseWarsTheme("bwm_contentBackground"), true)
	self.ButtonsPanel.Selected:SetAccentColor(GetBaseWarsTheme("bws_accent") or GetBaseWarsTheme("gen_accent"))
	self.ButtonsPanel.Selected.LerpFunc = function(s)
		return s:IsHovered()
	end
	self.ButtonsPanel.Selected.Draw = function(s,w,h)
		draw.SimpleText(self.localPlayer:GetLang("sellmenu_sellselectedfor"):format(BaseWars:FormatMoney(self.selectedValue * BaseWars.Config.BackMoney)), "BaseWars.20", w * .5, h * .5, GetBaseWarsTheme("bws_text") or GetBaseWarsTheme("bwm_text"), 1, 1)
	end
	...
	self.AllEntities:PaintScrollBar("bws")
	...
	self.SelectedEntities:PaintScrollBar("bws")
...
function PANEL:AddEntity(entity)
	...
	entityPanel.EntityName.Paint = function(s,w,h)
		...
		BaseWars:DrawRoundedBoxEx(4, 0, 0, w, h, GetBaseWarsTheme("bws_contentBackground2") or GetBaseWarsTheme("bwm_contentBackground2"), false, false, true, true)
		draw.SimpleText(name, "BaseWars.18", w * .5, h * .5, GetBaseWarsTheme("bws_text") or GetBaseWarsTheme("bwm_text"), 1, 1)
	end
