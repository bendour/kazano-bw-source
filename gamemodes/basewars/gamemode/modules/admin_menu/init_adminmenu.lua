if SERVER then
    ...
    AddCSLuaFile("basewars/gamemode/modules/admin_menu/html_loader.lua")
    AddCSLuaFile("basewars/gamemode/modules/admin_menu/html/admin_menu.html.lua")
    AddCSLuaFile("basewars/gamemode/modules/admin_menu/html/admin_menu.css.lua")
    AddCSLuaFile("basewars/gamemode/modules/admin_menu/html/admin_menu.js.lua")
    AddCSLuaFile("basewars/gamemode/modules/admin_menu/cl_admin_menu_html.lua")
end
