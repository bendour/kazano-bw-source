...
local FORCE_ENABLE = {
	...
	["bw_vgui"] = true,
	["commands"] = true,
	["f3menu"] = false, -- Disabled in favor of unified menu
	["f4menu"] = true,
	["faction"] = true,
	["level"] = true,
	["money"] = true,
	...
	["spawnmenu"] = true,
	["timeplay"] = true,
	["unifiedmenu"] = true, -- New unified menu system
}
...
function BaseWars:LoadModules(afterInitFunc)
	...
	local endLoadModules = SysTime()
	BaseWars:Log(Format("Successfully loaded " .. moduleCount .. " modules (" .. fileCount .. " Files) in %.5f sec.", endLoadModules - startLoadModules))
end
