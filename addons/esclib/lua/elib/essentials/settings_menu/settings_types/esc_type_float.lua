...
function stype:Build( parent )
	...
	function button:Paint(w,h)
		...
		draw.SimpleText(name,esclib:AdaptiveFont("esclib", 24, 500),offset_x,h*0.5,clr.button.text,TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
		draw.SimpleText(varc.value,esclib:AdaptiveFont("esclib", 24, 500),w-15,h*0.5,clr.button.accent,TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER,1)
	end
end