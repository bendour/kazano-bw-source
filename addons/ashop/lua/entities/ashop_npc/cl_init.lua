...
function ENT:RenderOverride()
    ...
    cam.Start3D2D(pos, ang, 0.2)
        ...
        draw.RoundedBox(8, -105, -25, 210, 50, boxColor) -- Box principale
        draw.SimpleText("Cosmétiques", "NPCHeader", 0 + 2, 0 + 2, shadowColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER) -- Ombre
        draw.SimpleText("Cosmétiques", "NPCHeader", 0, 0, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER) -- Texte principal
    cam.End3D2D()
end