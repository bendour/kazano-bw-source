...
gProtect.ShouldBlockAdvDupe2 = function(className)
	...
	if string.sub(src, #src - 24) != "advdupe2/sv_clipboard.lua" or curStack.name != "CreateEntityFromTable" then return false end

	return !cfg.whitelistedClasses[className]
end
