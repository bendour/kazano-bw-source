...
function ENT:RenderOverride()
    ...
    cam.Start3D2D(pos, ang, 0.2)
        ...
        draw.RoundedBox(8, -72.5, -25, 145, 50, boxColor) -- Box principale
        draw.SimpleText("Coinflip", "NPCHeader", 0 + 2, 0 + 2, shadowColor, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER) -- Ombre
        draw.SimpleText("Coinflip", "NPCHeader", 0, 0, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER) -- Texte principal
    cam.End3D2D()
end
