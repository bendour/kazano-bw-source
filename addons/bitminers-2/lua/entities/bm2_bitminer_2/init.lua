...
function ENT:Initialize()
	...
	self:SetModel("models/bitminers2/bitminer_3.mdl")
...
function ENT:MineBitcoin()
	self.bitcoin = self.bitcoin + ((self.clockSpeed * BM2CONFIG.BaseSpeed * BM2CONFIG.BitminerSpeedMulipliers["bitminerS2"]) * self.cores)
