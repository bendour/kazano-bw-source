...
-- 	GAMEMODE.Config.PocketBlacklist["zrush_barrel"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_drillhole"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_drillpipe_holder"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_machinecrate"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_module"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_npc"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_oilspot"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_palette"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_burner"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_drilltower"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_pump"] = true
-- 	GAMEMODE.Config.PocketBlacklist["zrush_refinery"] = true
-- end
...
zrush.config.MachineBuilder = {
	...
	SellValue = 0.8, // You get 50% of the original price
}
...
zrush.config.OilSpot = {
	...
	// This is the amount of oil its gonna loose per second if not caped by a pump (Set to -1 to disable it)
	OilLoss = 0,
}
