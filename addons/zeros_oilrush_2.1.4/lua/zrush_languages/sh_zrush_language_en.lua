...
if (zrush.config.selectedLanguage == "en") then
    ...
    zrush.language["YouSoldFuel"] = "You Sold $Amount$UoM $Fuelname for $Earning"
    ...
    zrush.language["Youbougt"] =  "You bought a $Name for $Price"
    zrush.language["YouSold"] =  "You sold a $Name for $Price"
