...
function ENT:Draw()
	...
	cam.Start3D2D(pos,ang,0.04)
		...
		draw.SimpleText(lean_updated.overheadtxt.val,"lean_top",0,50,Color(255,255,255),1,1)
		draw.SimpleText(lean_updated.subheading.val,"lean_ingredients",0,150,Color(255,255,255),1,1)
	cam.End3D2D()
end