...
// Should the player drop all his meth if he dies (Only applys to meth which he picked up in the because of SellMode 1 or 3)
zmlab2.config.DropMethOnDeath = false


// You can use this to restrict what job is allowed to interact with the Methlab Entities (Leave empty to allow everyone to interact)
zmlab2.config.Jobs = {}
if TEAM_ZMLAB2_COOK then zmlab2.config.Jobs[TEAM_ZMLAB2_COOK] = true end


// You can use this to restrict what job is allowed to sell meth (Leave empty to allow everyone to interact)
