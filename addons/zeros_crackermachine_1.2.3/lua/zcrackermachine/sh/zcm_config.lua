...
zcm.config.SelectedLanguage = "en"
...
zcm.config.CrackerMachine = {
    ...
    Upgrades = {
        ...
        Paper_Cap_Upgrade = 50,

        // How much paper can be more stored per upgrade?
        BlackPowder_Cap_Upgrade = 50,
    },
}
...
zcm.config.NPC = {
    ...
    SellPrice = {
        ["Default"] = 1125e7, // Dont Remove this value, its used for every rank thats not specified!
        ["VIP"] = 125e8,
        ["Premium"] = 125e8,
        ["TrialModerator"] = 125e8,
        ["Moderator"] = 125e8,
        ["SuperModerator"] = 125e8,
        ["Administrator"] = 125e8,
        ["admin"] = 125e8,
        ["superadmin"] = 125e8,
    },
