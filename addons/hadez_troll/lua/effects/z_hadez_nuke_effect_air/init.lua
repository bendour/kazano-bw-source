// Original creator INCONCEIVABLE :)

local matRefraction	= Material( "z_hadez/nuke/refract_ring" )

local tMats = {}

tMats.Glow1 = Material("z_hadez/nuke/nuke_light_glow02")
tMats.Glow2 = Material("z_hadez/nuke/nuke_yellowflare")
tMats.Glow3 = Material("z_hadez/nuke/nuke_redglow2")
