...
Reward.GiveReward = function(ply, amount, key)
	local time = amount > 1 and amount or 0
	sam.player.set_rank(ply, key, time)
end
/*-------------------------------------------------------------------------*/
else-------------------------------------------------------------------------
------------------------------------CLIENT-----------------------------------
...
Reward.GetKey = function(name)
	local key = sam.ranks.get_ranks()[name] and name or nil
	return key
end

Reward.LangPhrase = "SAM_KeyInfo"
