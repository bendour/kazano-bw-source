...
ADRewards.Config.KEY = KEY_N-- Button to show the emoji circle. List of buttons: https://wiki.facepunch.com/gmod/Enums/KEY . Or false to disable

ADRewards.Config.OpenJoin = false -- Open menu when a player joins the server
...
ADRewards.Config.TasksForClaim = true -- Does the player need to complete all the tasks for the day to get the reward? If false and there is no task reward, disables daily tasks

ADRewards.Config.LevelPerTask = true -- NEW: If true, each completed task gives 1 level. If false, all 3 tasks must be completed for 1 level.

ADRewards.Config.PremiumURL = "https://kazano.fr" -- Which link opens when you click the "Premium" button
