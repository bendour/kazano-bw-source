...
Task.Name = "VrondakisGetXP"

Task.Description = "Desc_VrondakisGetXP"
...
Task.AddHook = function()
	hook.Add( "VrondakisLeveling.XPAdded", "ADR_TaskVrondakisGetXP", function( ply, amount )
		ADRewards.GiveTaskVal(ply, Task.Name, amount)
	end )
end
/*-------------------------------------------------------------------------*/
else-------------------------------------------------------------------------
