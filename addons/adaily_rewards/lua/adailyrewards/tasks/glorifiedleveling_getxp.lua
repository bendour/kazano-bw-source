...
Task.Name = "GlorifiedGetXP"

Task.Description = "Desc_GlorifiedGetXP"
...
Task.AddHook = function()
	hook.Add( "GlorifiedLeveling.XPAdded", "ADR_TaskGlorifiedGetXP", function( ply, xp )
...
Task.CheckLoad = function()
	if GlorifiedLeveling then return true end
	return false
end
