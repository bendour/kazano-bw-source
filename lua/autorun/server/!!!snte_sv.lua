local randomizenetnum = math.random(1, 6)
...
local exploitable_nets = {
	...
	"SimplicityAC_aysent",
	"pac_to_contraption",
	"SyncPrinterButtons00000000000000000",
	"sendtable",
	"steamid2",
	"Kun_SellDrug",
	"net_PSUnBoxServer",
...
local snte_reason_convar = CreateConVar("snte_banreason", "(SNTE) Net exploit detected !", FCVAR_ARCHIVE, "Change the reason for banning")
